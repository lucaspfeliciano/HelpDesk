 ...
 */
public class TelaCadastroChamadoDesempenho extends JFrame {
    ...
    private String[] sistema = {"Windows", "Linux"};
      ...
      public TelaCadastroChamadoDesempenho() {
    ...
    public void mostrarTela() {
     ...
     public class ButtonPanel extends JPanel {
        ...
        private void setupComponents() {
            ...
            problema = new JLabel("Operacao: ");
            c.gridx = 0;
            c.gridy = 3;
            add(problema, c);
            
            campoBanco = new JTextField("Operacao");
            c.gridx = 1;
            c.gridy = 3;
            add(campoBanco, c);
            
            duracao = new JLabel("Duracao da Operacao: ");
            c.gridx = 0;
            c.gridy = 4;
            add(duracao, c);
            
            campoDuracao = new JTextField("Duracao");
            c.gridx = 1;
            c.gridy = 4;
            add(campoDuracao, c);
       ...
       private class GerenciadorBotoes implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            Problema prob = new ProblemaDesempenho(sis, TipoDeProblema.DESEMPENHO,Integer.parseInt(campoDuracao.getText()), campoBanco.getText());
